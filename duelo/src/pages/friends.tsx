          ...
          <div className="space-y-2">
            {isLoading ? (
              ...
              sortedFriends.map((friend) => {
                const isMe = friend.uid === user.uid;
                return (
                  <div
                    key={friend.uid}
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        navigate(isMe ? "/profile" : `/profile/${friend.uid}`)
                      }
                      className="relative flex-shrink-0 focus:outline-none"
                    >
                      <div className="w-10 h-10 rounded-full border-2 border-sand/30 overflow-hidden hover:border-gold/60 transition-colors">
                        <img
                    ...
                    >
                      <div className="font-western text-sm text-sand-light tracking-wider truncate hover:text-gold transition-colors">
                        {friend.displayName}
                      </div>
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-10 h-10 rounded-full border-2 border-gold/40 overflow-hidden flex-shrink-0 hover:border-gold transition-colors focus:outline-none"
                    >
                      <img
                        src={resolveAvatarPicture(
                          req.fromAvatar,
