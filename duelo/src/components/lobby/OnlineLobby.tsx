  ...
  return (
    <div className="min-h-screen bg-[url('/assets/ui/bg_desert_portrait.png')] md:bg-[url('/assets/ui/bg_desert_landscape.png')] bg-cover bg-center flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Character Selection */}
        <div className="card-wood p-4 mb-4 animate-fade-up">
          <h3 className="font-western text-sm text-sand/60 text-center mb-3 tracking-widest">SEU PISTOLEIRO</h3>
        ...
        {/* Actions */}
        <div className="card-wood p-6 animate-fade-up animate-fade-up-delay-1">
          ...
          <form onSubmit={handleJoin} className="flex flex-col gap-3">
            <input 
              ...
              className="input-parchment text-center text-2xl font-western uppercase tracking-[0.3em]"
            />
            {error && <div className="text-red-400 font-stats text-sm text-center">{error}</div>}
            <button type="submit" className="btn-western btn-sky">
              ENTRAR NA SALA
            </button>
          </form>
        </div>
